...
Процедура ПриЗагрузкеБиблиотеки(Путь, СтандартнаяОбработка, Отказ)
	...
	Если Осень <> Неопределено Тогда
		ПутьДоЗаготовки = ОбъединитьПути(Путь, "src/Заготовки/ИнициализацияФабрикиЛогов.os");
		ПодключитьСценарий(ПутьДоЗаготовки, "ИнициализацияФабрикиЛогов");
		Осень.ДобавитьЗаготовкуДляАвтоИнициализации("ИнициализацияФабрикиЛогов");
